...
var fileDescriptor_79d113b3c336ec06 = []byte{
	...
	0x0b, 0x15, 0xe5, 0xe7, 0xa4, 0x42, 0x04, 0x94, 0xbc, 0xb8, 0xd8, 0x02, 0xc0, 0x0a, 0x84, 0x74,
	...
	0x41, 0x70, 0x15, 0x42, 0x42, 0x5c, 0x2c, 0xa1, 0xa1, 0x9e, 0x2e, 0x12, 0x4c, 0x0a, 0x8c, 0x1a,
	0x9c, 0x41, 0x60, 0xb6, 0x93, 0xe6, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78,
	0x24, 0xc7, 0x38, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0xb8, 0xa7, 0x5f, 0x70, 0x6a, 0x51, 0x59, 0x6a,
	0x91, 0x7e, 0x71, 0x51, 0xb2, 0x3e, 0xd8, 0x46, 0x7d, 0x90, 0x0b, 0x92, 0xd8, 0xc0, 0x6c, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xe8, 0x74, 0x94, 0x5f, 0xa3, 0x00, 0x00, 0x00,
}
...
func (m *Player) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UUID) > 0 {
		i -= len(m.UUID)
		copy(dAtA[i:], m.UUID)
		i = encodeVarintDataPlayer(dAtA, i, uint64(len(m.UUID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.RoleList) > 0 {
