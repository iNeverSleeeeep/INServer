...
func (EntityType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6bb85d6cbe16384d, []int{0}
}
...
type EntityRealtimeData struct {
	...
	CurrentMapUUID       string   `protobuf:"bytes,2,opt,name=CurrentMapUUID,proto3" json:"CurrentMapUUID,omitempty"`
...
func (m *EntityRealtimeData) GetCurrentMapUUID() string {
	if m != nil {
		return m.CurrentMapUUID
	}
	return ""
}
...
func (*EntityData) Descriptor() ([]byte, []int) {
	return fileDescriptor_6bb85d6cbe16384d, []int{1}
}
...
func init() { proto.RegisterFile("data.entity.proto", fileDescriptor_6bb85d6cbe16384d) }

var fileDescriptor_6bb85d6cbe16384d = []byte{
	// 303 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *EntityRealtimeData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CurrentMapUUID) > 0 {
		i -= len(m.CurrentMapUUID)
		copy(dAtA[i:], m.CurrentMapUUID)
		i = encodeVarintDataEntity(dAtA, i, uint64(len(m.CurrentMapUUID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.LastStaticMapUUID) > 0 {
		...
		i = encodeVarintDataEntity(dAtA, i, uint64(len(m.LastStaticMapUUID)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *EntityData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Components) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintDataEntity(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x1a
		}
	...
	if len(m.EntityUUID) > 0 {
		...
		i = encodeVarintDataEntity(dAtA, i, uint64(len(m.EntityUUID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintDataEntity(dAtA []byte, offset int, v uint64) int {
	offset -= sovDataEntity(v)
	base := offset
	for v >= 1<<7 {
...
func (m *EntityRealtimeData) Size() (n int) {
	...
	if l > 0 {
		n += 1 + l + sovDataEntity(uint64(l))
	}
	l = len(m.CurrentMapUUID)
	if l > 0 {
		n += 1 + l + sovDataEntity(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func sovDataEntity(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozDataEntity(x uint64) (n int) {
	return sovDataEntity(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *EntityRealtimeData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowDataEntity
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthDataEntity
			}
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentMapUUID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CurrentMapUUID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDataEntity(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipDataEntity(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowDataEntity
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthDataEntity
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupDataEntity
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthDataEntity        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowDataEntity          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupDataEntity = fmt.Errorf("proto: unexpected end of group")
)
