...
var fileDescriptor_48a3ff9f7c9032f8 = []byte{
	...
	,
}
...
func (m *DBRole) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnlineData) > 0 {
		...
		i = encodeVarintRole(dAtA, i, uint64(len(m.OnlineData)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.SummaryData) > 0 {
		...
		i = encodeVarintRole(dAtA, i, uint64(len(m.SummaryData)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.UUID) > 0 {
		i -= len(m.UUID)
		copy(dAtA[i:], m.UUID)
		i = encodeVarintRole(dAtA, i, uint64(len(m.UUID)))
		i--
		dAtA[i] = 0xa
	}
