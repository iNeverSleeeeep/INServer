...
var fileDescriptor_0cc45f6ac745dd88 = []byte{
	...
	0x4c, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x57, 0xd2, 0xe4, 0xe2, 0x76, 0x02, 0x71, 0x9d, 0xf3,
	0xf3, 0xd2, 0x32, 0xd3, 0x85, 0xa4, 0xb8, 0x38, 0xdc, 0x13, 0x73, 0x53, 0xfd, 0x12, 0x73, 0x53,
	0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xe0, 0x7c, 0x27, 0x8d, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc6, 0x63, 0x39, 0x86, 0x28, 0x31, 0x4f, 0xbf,
	0xe0, 0xd4, 0xa2, 0xb2, 0xd4, 0x22, 0xfd, 0xe2, 0xa2, 0x64, 0x7d, 0xb0, 0x81, 0xfa, 0xa9, 0x25,
	0xc9, 0x49, 0x6c, 0x60, 0xa6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xb0, 0x5c, 0x36, 0x16, 0x6a,
	0x00, 0x00, 0x00,
}
...
func (m *BasicConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GameName) > 0 {
		...
		i = encodeVarintBasic(dAtA, i, uint64(len(m.GameName)))
		i--
		dAtA[i] = 0xa
	}
